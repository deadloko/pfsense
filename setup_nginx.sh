...
pfSense_gui_branch="v2_4_5" # Replace with the version you want to build
pfSense_port_branch="v2_4_5" # Replace with the version you want to build
...
ln -s "$invoke_dir"/tmp/"$product_name"_"$pfSense_gui_branch"_amd64-core/.latest packages/"$product_name"_"$pfSense_gui_branch"_amd64-core
